          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                {/* ALTERAÇÃO AQUI: Link de rastreio agora em rosa */}
                <a id="footer-rastrear" href="https://www.correios.com.br/rastreamento" target="_blank" rel="noopener noreferrer" className="flex items-center text-pink-600 font-semibold hover:text-pink-500 transition-colors">
